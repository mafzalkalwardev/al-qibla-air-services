    ...
    <>
      <section className="bg-navy py-20 text-white">
        <div className="container-wide text-center">
          <h1 className="font-heading text-4xl font-bold md:text-5xl">Available Group Tickets</h1>
          <p className="mx-auto mt-4 max-w-2xl text-white/70">
            Professional B2B-style group fare portal. Filter by airline, sector, date and price.
          </p>
        </div>
      </section>
