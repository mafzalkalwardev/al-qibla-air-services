            ...
            <div className="flex items-center gap-4 sm:flex-col sm:items-end">
              ...
              <div className="flex gap-2">
                ...
                {ticket.status !== "sold_out" ? (
                  <a
                    href={`${SITE.whatsapp}?text=${whatsappMsg}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className={cn(buttonVariants({ size: "sm" }), "bg-gold text-navy hover:bg-gold-light whitespace-nowrap")}
                  >
                    Book Now
                  </a>
                ) : (
