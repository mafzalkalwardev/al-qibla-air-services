...
export const umrahPackages: TravelPackage[] = [
  {
    ...
    image: "/assets/gallery/umrah-1.svg", featured: true,
  },
  {
    ...umrahBase,
    ...
    image: "/assets/gallery/umrah-2.svg", featured: true,
  },
  {
    ...umrahBase,
    ...
    image: "/assets/gallery/umrah-3.svg", featured: true,
  },
  {
    ...umrahBase,
    ...
    image: "/assets/gallery/umrah-4.svg", featured: false,
  },
  {
    ...umrahBase,
    ...
    image: "/assets/gallery/umrah-5.svg", featured: false,
  },
  {
    ...umrahBase,
    ...
    image: "/assets/gallery/umrah-1.svg", featured: false,
  },
];

export const tourPackages: TravelPackage[] = [
  { id: "t1", title: "Dubai Explorer", slug: "dubai-explorer", price: 145000, currency: "PKR", duration: "5 Days / 4 Nights", hotelStars: 4, destination: "Dubai", highlights: ["Return flights", "4-star hotel", "Desert safari", "City tour"], image: "/assets/gallery/tour-1.svg", featured: true, status: "active", type: "tour" },
  { id: "t2", title: "Turkey Heritage Tour", slug: "turkey-heritage", price: 220000, currency: "PKR", duration: "8 Days / 7 Nights", destination: "Turkey", highlights: ["Istanbul & Cappadocia", "Guided tours", "Breakfast included"], image: "/assets/gallery/tour-2.svg", featured: true, status: "active", type: "tour" },
  { id: "t3", title: "Malaysia & Singapore", slug: "malaysia-singapore", price: 265000, currency: "PKR", duration: "10 Days / 9 Nights", destination: "Malaysia", highlights: ["Twin city package", "Theme parks", "Shopping tours"], image: "/assets/gallery/tour-3.svg", featured: false, status: "active", type: "tour" },
  { id: "t4", title: "Thailand Getaway", slug: "thailand-getaway", price: 195000, currency: "PKR", duration: "7 Days / 6 Nights", destination: "Thailand", highlights: ["Bangkok & Pattaya", "Island tour", "Hotel & transfers"], image: "/assets/gallery/gallery-6.svg", featured: false, status: "active", type: "tour" },
  { id: "t5", title: "Azerbaijan Discovery", slug: "azerbaijan-discovery", price: 175000, currency: "PKR", duration: "6 Days / 5 Nights", destination: "Azerbaijan", highlights: ["Baku city tour", "Flame Towers", "Old City"], image: "/assets/gallery/dest-baku.svg", featured: false, status: "active", type: "tour" },
  { id: "t6", title: "Northern Pakistan", slug: "northern-pakistan", price: 85000, currency: "PKR", duration: "6 Days / 5 Nights", destination: "Pakistan", highlights: ["Hunza & Skardu", "Private transport", "Hotels"], image: "/assets/gallery/tour-4.svg", featured: false, status: "active", type: "tour" },
];
